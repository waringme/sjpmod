...
function buildHeroBlock(main) {
  ...
  if (h1 && picture && (h1.compareDocumentPosition(picture) & Node.DOCUMENT_POSITION_PRECEDING)) {
    // Check if h1 or picture is already inside a hero block (including hero-wealth)
    if (h1.closest('.hero') || picture.closest('.hero')
      || h1.closest('.hero-wealth') || picture.closest('.hero-wealth')) {
      return; // Don't create a duplicate hero block or strip hero-wealth content
    }
